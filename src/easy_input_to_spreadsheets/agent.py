...
from easy_input_to_spreadsheets.tools import set_manager, create_spreadsheet_server, SPREADSHEET_TOOL_NAMES
...
from easy_input_to_spreadsheets.voice_input import get_voice_input, check_voice_available
